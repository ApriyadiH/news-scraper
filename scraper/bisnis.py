    ...
    for category in category_list:
        ...
        while page <= max_page:
            ...
            for article in articles:
                ...
                is_today = (
                    "jam yang lalu" in date_scraped
                    or "menit yang lalu" in date_scraped
                    or "detik yang lalu" in date_scraped
                )
            ...
            print(
                f"Bisnis.com, Category {category['name']}, Page {page}: collected {len(results)} total so far"
            )
