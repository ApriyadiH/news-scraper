...
class DateSelector(QGroupBox):
    ...
    def setup_ui(self):
        ...
        # ---------------------------------------------------------
        # Row 2 — Number of days / All available data
        # ---------------------------------------------------------
        ...
        self.export_all.toggled.connect(
            self.toggle_export_dates
        )

        # ---------------------------------------------------------
        # Scraping date update
        # ---------------------------------------------------------

        self.scrape_days.valueChanged.connect(
